...
{
  fastfetch --logo "$HOME\Documents\Powershell\dotfiles\fastfetch\koala.txt" --config "$HOME\Documents\Powershell\dotfiles\fastfetch\config.jsonc"
}

Import-Module -Name Terminal-Icons

# Start Oh-My-Posh with the specified configuration file.
oh-my-posh init pwsh --config "$HOME/Documents/Powershell/dotfiles/ohmyposh/catpuccino-mocha.omp.json" | Invoke-Expression
